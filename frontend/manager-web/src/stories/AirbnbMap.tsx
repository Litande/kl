...
function GeoCustom({ width, height, events = true }: GeoCustomProps) {
  const [projection, setProjection] = useState<keyof typeof PROJECTIONS>("geoNaturalEarth1");
        ...
        {zoom => (
          <div className="container">
            ...
            >
              ...
              <CustomProjection<IFeatureShape>
...
export const GeoMap = () => <GeoCustom width={600} height={450} />;
