...
public class NewStatusWasXConsecutiveTimesYPeriod : RuleConditionBase
{
    public NewStatusWasXConsecutiveTimesYPeriod() : base(
        new RuleGroupTypes[]
        {
        ...
        new RuleConditionDescription(
            RulesCondition.NewStatusWasXConsecutiveTimesYPeriod.ToString(),
            RulesCondition.NewStatusWasXConsecutiveTimesYPeriod.ToDescription(),
